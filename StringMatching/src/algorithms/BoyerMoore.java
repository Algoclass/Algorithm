...
public class BoyerMoore {
	...
	public static void main(String args[]) {
		 ...
		 * ; t= t.replaceAll(" ",""); char txt[] = t.toCharArray(); String p=
		 ...
		 * ; p= p.replaceAll(" ",""); char pat[] =p.toCharArray();
		 */
		/*
		 ...
		 * p.replaceAll(" ",""); char pat[] =p.toCharArray(); testCounter = j;
		 * search(txt, pat); } }
		 */
	 ...
	 * Moore Algorithm
	 */
	static void search(char txt[], char pat[], int file_number,
		...
		while (s <= (n - m)) {
			...
			if (j < 0) {
				...
				System.out.println("Pattern found for para in pattern"
						+ patternCounter + " for test" + testCounter);
