...
public class RabinKarp {
	...
	static void search( char txt[],char pat[], int q , int file_number,ArrayList<String> corpus)
	{
	    ...
	    for (i = 0; i <= N - M; i++)
	    {
	        ...
	        if ( p == t )
	        {
	            ...
	            if (match)  // if p == t and pat[0...M-1] = txt[i, i+1, ...i+M-1]
	            {
	...
	/*static void search( char txt[],char pat[], int q)
	{
		String patt = String.copyValueOf(pat);
